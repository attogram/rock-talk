...
Strict (Ultra). Fragmented. Non-inflected. Low-bandwidth response. Fluid
(Lite). Compressed prose. Natural words. Zero fluff. Collaborative
engineering. Phatic (Non-Protocol). Verbose. Socially-packaged. Team
sync. [Givón, 1979, On Understanding Grammar](#givon1979): Pragmatic vs
...
Anglocentric. packaging register shifts (Japanese. Korean. Thai) serve
social functions. Alignment Tradeoff: Trade social alignment (politeness) for
