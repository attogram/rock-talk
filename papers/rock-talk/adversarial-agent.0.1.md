...
Paper:
https://github.com/attogram/rock-talk/blob/main/papers/rock-talk/adversarial-agent.0.1.md
...
loop restarts or escalates to a human operator.
...
reconstruction.
3.  **Error Capture Rate**: The percentage of technical errors or
